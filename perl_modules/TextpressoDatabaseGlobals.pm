...
use constant DB_ROOT => '/srv/www/airframe/htdocs/tdb/';
### -----  system specific: --------------- 
...
use constant DB_TMP => '/srv/www/airframe/htdocs/temp';
### ---------------------------------------
use constant DB_STOPWORDS => '/srv/www/airframe/htdocs/misc/stopwords';
